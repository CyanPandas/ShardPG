...
#define CONFIGURE_ARGS " '--prefix=/work/pg-install' '--with-openssl' '--with-icu' '--with-readline'"
...
#define PG_VERSION_STR "PostgreSQL 16.14 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0, 64-bit"
