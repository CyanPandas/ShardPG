...
| **C. 游标到了、数据没到**（真问题，需深挖） | `promote_catchup_tx3` 2、`lazy_replay_l1` 1 | tx3：新主 `applied=48` 追平、字节全到，40 行读到 0（等满 15 s）；l1：游标 `durable=990` 未回退、"追平到 990"，数据却是 283/70713 vs 433/232038。**两者同族** |
