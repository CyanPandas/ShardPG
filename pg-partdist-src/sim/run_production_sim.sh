...
run_test 5 "批量写入 COPY 路径恢复"            "BULK_OVERHEAD_THRESHOLD=100 bash tests/test_bulk_insert_recovery.sh 2>&1"
...
run_test 9 "端到端延迟性能 (500样本, 32并发)" "bash \"${SCRIPT_DIR}/../tests/perf_latency.sh\" 2>&1" "true"
